...
<section class="sidebar">
    ...
    <li class="{{ (request()->is('superadmin*')) ? 'active' : '' }}"><a href="/superadmin"><i class="fa fa-edit"></i> <span>Absensi</span></a></li>
    ...
    <li class="{{ (request()->is('superadmin*')) ? 'active' : '' }}"><a href="/superadmin"><i class="fa fa-file"></i> <span>Print Laporan</span></a></li>
