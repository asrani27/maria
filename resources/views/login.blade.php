...
background: radial-gradient(circle, rgba(247,247,247,1) 0%, rgba(82,80,80,1) 91%);">
<div class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="text-center">
              <img src="/logo/pemko.png" width="20%">
              <h1>DISBUDPORAPAR</h1>
            </div>
          <br/><br/>
            <div class="box box-success" style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);border-top-color:#fea100">
              <div class="box-header with-border text-center">
                <h3 class="box-title">MONITORING CAGAR BUDAYA</h3>
              ...
              <div class="box-footer social-auth-links">
                <button type="submit" class="btn btn-flat btn-warning btn-block" style=" color:white;"><i class="fa fa-sign-in"></i> Masuk</button>
              </div>
              </form>
            </div>
          </div>
